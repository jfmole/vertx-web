...
a clustered session store they can be any basic type, or `link:../../vertx-core/groovy/groovydoc/io/vertx/groovy/core/buffer/Buffer.html[Buffer]`, `JsonObject`,
...
To create an auth handler you need an instance of `link:../../vertx-auth-common/groovy/groovydoc/io/vertx/groovy/ext/auth/AuthProvider.html[AuthProvider]`. Auth provider is
...
If the auth handler has successfully authenticated and authorised the user it will inject a `link:../../vertx-auth-common/groovy/groovydoc/io/vertx/groovy/ext/auth/User.html[User]`
...
When the basic auth handler receives this information, it calls the configured `link:../../vertx-auth-common/groovy/groovydoc/io/vertx/groovy/ext/auth/AuthProvider.html[AuthProvider]`
...
The event is also an instance of `link:../../vertx-core/groovy/groovydoc/io/vertx/groovy/core/Future.html[Future]`. When you are finished handling the event you can
